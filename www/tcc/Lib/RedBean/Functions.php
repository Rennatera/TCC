...
if (!function_exists('EID')) {
	...
	{
		return \Lib\RedBean\Facade::enum( $enumName )->id;
	}
...
if ( !function_exists( 'dmp' ) ) {
	...
	function dmp( $list )
	{
		print_r( \Lib\RedBean\Facade::dump( $list ) );
	}
}
...
if ( !function_exists( 'genslots' ) ) {
	...
	{
		return \Lib\RedBean\Facade::genSlots( $slots, $tpl );
	}
}
...
if ( !function_exists( 'array_flatten' ) ) {
	...
	{
		return \Lib\RedBean\Facade::flat( $array );
	}
}
