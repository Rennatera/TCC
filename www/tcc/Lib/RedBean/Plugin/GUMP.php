...
class GUMP
{
    ...
    public function get_readable_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    $resp['message'] = "Não existem regras de validação para o campo $field";
                    break;
                case 'validate_required':
                    $resp['message'] = "O campo $field é obrigatório";
                    break;
                case 'validate_valid_email':
                    $resp['message'] = "O campo $field deve conter um endereço de email válido";
                    break;
                case 'validate_max_len':
                    $resp['message'] = "O campo $field deve conter $param ou menos caracteres";
                    break;
                case 'validate_min_len':
                    $resp['message'] = "O campo $field deve conter $param ou mais caracteres";
                    break;
                case 'validate_exact_len':
                    $resp['message'] = "O campo $field deve ter $param caracteres";
                    break;
                case 'validate_alpha':
                    $resp['message'] = "O campo $field deve conter apenas caracteres alfabéticos(a-z)";
                    break;
                case 'validate_alpha_numeric':
                    $resp['message'] = "O campo $field deve conter apenas caracteres alfanuméricos";
                    break;
                case 'validate_alpha_dash':
                    $resp['message'] = "O campo $field deve conter apenas caracteres alfabéticos &amp; traços";
                    break;
                case 'validate_numeric':
                    $resp['message'] = "O campo $field deve conter apenas caracteres numéricos";
                    break;
                case 'validate_integer':
                    $resp['message'] = "O campo $field deve conter apenas caracteres numéricos inteiros";
                    break;
                case 'validate_boolean':
                    $resp['message'] = "O campo $field deve conter apenas verdadeiro ou falso";
                    break;
                case 'validate_float':
                    $resp['message'] = "O campo $field deve conter apenas decimais";
                    break;
                case 'validate_valid_url':
                    $resp['message'] = "O campo $field deve conter uma URL válida";
                    break;
                case 'validate_url_exists':
                    $resp['message'] = "O campo $field possui uma URL inexistente";
                    break;
                case 'validate_valid_ip':
                    $resp['message'] = "O campo $field deve conter um IP válido";
                    break;
                case 'validate_valid_cc':
                    $resp['message'] = "O campo $field deve conter um número de cartão de crédito válido";
                    break;
                case 'validate_valid_name':
                    $resp['message'] = "O campo $field deve conter um nome humano válido";
                    break;
                case 'validate_contains':
                    $resp['message'] = "O campo $field deve conter um dos seguintes valores: ".implode(', ', $param);
                    break;
                case 'validate_contains_list':
                    $resp['message'] = "O campo $field deve conter um dos valores de sua lista";
                    break;
                case 'validate_doesnt_contain_list':
                    $resp['message'] = "O campo $field contem um valor não aceitável";
                    break;
                case 'validate_street_address':
                    $resp['message'] = "O campo $field deve conter um endereço válido";
                    break;
                case 'validate_date':
                    $resp['message'] = "O campo $field deve conter uma data válida";
                    break;
                case 'validate_min_numeric':
                    $resp['message'] = "O campo $field deve conter um valor numérico, igual a, ou maior que $param";
                    break;
                case 'validate_max_numeric':
                    $resp['message'] = "O campo $field deve conter um valor numérico, igual to, ou menor que $param";
                    break;
                case 'validate_min_age':
                    $resp['message'] = "O campo $field deve conter uma idade maior ou igual a $param";
                    break;
                default:
                    $resp['message'] = "O campo $field é inválido";
            }
        }
    ...
    */
    ...
    /**
     * Replace non numeric chars from string
     *
     * @param string $value
     * @param array  $params
     *
     * @return string
     */
    protected function filter_clean_cpf($value, $params = null)
    {
    ...
    /**
     * Verify that a value is a valid hexadecimal string (CUSTOM)
     *
     * @param string $field
     * @param array  $input
     * @param null   $param
     ...
     * @return mixed
     */
    protected function validate_hexadecimal($field, $input, $param = null)
    {
