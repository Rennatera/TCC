...
namespace Lib\RedBean;

use Lib\RedBean\QueryWriter as QueryWriter;
use Lib\RedBean\Adapter\DBAdapter as DBAdapter;
use Lib\RedBean\RedException\SQL as SQLException;
use Lib\RedBean\Logger as Logger;
use Lib\RedBean\Logger\RDefault as RDefault;
use Lib\RedBean\Logger\RDefault\Debug as Debug;
use Lib\RedBean\Adapter as Adapter;
use Lib\RedBean\QueryWriter\AQueryWriter as AQueryWriter;
use Lib\RedBean\RedException as RedException;
use Lib\RedBean\BeanHelper\SimpleFacadeBeanHelper as SimpleFacadeBeanHelper;
use Lib\RedBean\Driver\RPDO as RPDO;
use Lib\RedBean\Util\MultiLoader as MultiLoader;
use Lib\RedBean\Util\Transaction as Transaction;
use Lib\RedBean\Util\Dump as Dump;
use Lib\RedBean\Util\DispenseHelper as DispenseHelper;
use Lib\RedBean\Util\ArrayTool as ArrayTool;
...
class Facade
{
	...
	public static function addDatabase( $key, $dsn, $user = NULL, $pass = NULL, $frozen = FALSE )
	{
		...
		$writerClass = '\\Lib\\RedBean\\QueryWriter\\'.$writers[$wkey];
