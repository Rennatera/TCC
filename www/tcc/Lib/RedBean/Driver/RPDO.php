...
namespace Lib\RedBean\Driver;

use Lib\RedBean\Driver as Driver;
...
use Lib\RedBean\RedException\SQL as SQL;
use Lib\RedBean\Logger\RDefault as RDefault;
use Lib\RedBean\PDOCompatible as PDOCompatible;
use Lib\RedBean\Cursor\PDOCursor as PDOCursor;
