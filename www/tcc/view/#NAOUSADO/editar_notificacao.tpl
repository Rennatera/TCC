...
<form action="upload.php" method="post" enctype="multipart/form-data">
  ...
  <button class="btn btn-primary " type="submit" value="cadastrar" name=" cadastra" id="cadastrar"  >
        Cadastrar

       </button>
        
          <a class="btn btn-danger"  href="#" data-toggle="modal" data-target="#voltar-modal">Fechar</a>
       </form>
       </form>
       </form>
       
       <!-- Modal -->
<div class="modal fade" id="voltar-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modalLabel">Voltar E Cancelar Edição</h4>
            </div>
            <div class="modal-body">Deseja realmente Sair da pagina e cancelar a edição? </div>
            <div class="modal-footer">
                <a href="http://aduvi.com.br/Principal_notificacao_instituicao" class="btn btn-primary">Sim</a>
